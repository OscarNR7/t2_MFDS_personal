 ...
 */
export default function Step2_Info({ onNext, onBack, listingData, updateListingData }) {
  ...
  const validateStep = () => {
    ...
    if (!listingData.description) newErrors.description = 'La descripción es obligatoria.';
    if (!listingData.price || parseFloat(listingData.price) <= 0) newErrors.price = 'Ingresa un precio válido.';
    if (!listingData.quantity || parseInt(listingData.quantity) <= 0) newErrors.quantity = 'Ingresa una cantidad válida.';
    if (!listingData.condition) newErrors.condition = 'Selecciona una condición.';
    ...
    <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-6 md:p-8">
      <div className="flex flex-col gap-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          />
          {errors.title && <p className="text-red-500 text-sm -mt-4 md:col-span-2">{errors.title}</p>}
          ...
          <FormInput
            ...
            className="md:col-span-2"
          />
          {errors.description && <p className="text-red-500 text-sm -mt-4 md:col-span-2">{errors.description}</p>}
          ...
          <FormInput
            ...
            step="0.01"
          />
          {errors.price && <p className="text-red-500 text-sm -mt-4">{errors.price}</p>}
          ...
          <FormInput
            ...
            step="1"
          />
          {errors.quantity && <p className="text-red-500 text-sm -mt-4">{errors.quantity}</p>}
          ...
          <div className="relative w-full md:col-span-2">
            ...
            <select
              ...
              className={`w-full p-3 border border-gray-400 dark:border-gray-600 rounded-xl appearance-none
                          ...
                          ${!listingData.condition ? 'text-gray-500' : 'text-black dark:text-white'}`}
            >
